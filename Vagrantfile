...
ANSIBLE_ROLE = 'ansible-role-celery'
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define 'ubuntu-xenial' do |ubuntu_x|
    ...
    ubuntu_x.vm.provision 'shell', inline: "mkdir -p /vagrant/roles && ln -sf /vagrant /vagrant/roles/#{ANSIBLE_ROLE}"
    ubuntu_x.vm.provision 'shell', inline: "ansible-galaxy install -r /vagrant/requirements.yml -p /vagrant/roles"
  ...
  config.vm.define 'ubuntu-trusty' do |ubuntu_t|
    ...
    ubuntu_t.vm.provision 'shell', inline: "mkdir -p /vagrant/roles && ln -sf /vagrant /vagrant/roles/#{ANSIBLE_ROLE}"
    ubuntu_t.vm.provision 'shell', inline: "ansible-galaxy install -r /vagrant/requirements.yml -p /vagrant/roles"
  ...
  config.vm.define 'centos-7' do |centos7|
    ...
    centos7.vm.provision 'shell', inline: "mkdir -p /vagrant/roles && ln -sf /vagrant /vagrant/roles/#{ANSIBLE_ROLE}"
    centos7.vm.provision 'shell', inline: "ansible-galaxy install -r /vagrant/requirements.yml -p /vagrant/roles"
  ...
  config.vm.define 'centos-6' do |centos6|
    ...
    centos6.vm.provision 'shell', inline: "mkdir -p /vagrant/roles && ln -sf /vagrant /vagrant/roles/#{ANSIBLE_ROLE}"
    centos6.vm.provision 'shell', inline: "ansible-galaxy install -r /vagrant/requirements.yml -p /vagrant/roles"
